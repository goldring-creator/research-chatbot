...
| 📎 | 초안 파일 첨부(txt·md·pdf·docx·hwpx) → 검토 |
| 💾 / 📂 | 대화 저장 / 불러오기 |
| 📌 | 항상 위 켜기/끄기 |
| ❓ / 🔑 | 도움말 / 키 변경 |

- 전송: **Enter** · 줄바꿈: **Shift+Enter**
- 전역 단축키(설치 시): **⌘+Shift+R**(Mac) / **Ctrl+Shift+R**(Win) 으로 창 보이기/숨기기
  (Mac은 시스템 설정 → 손쉬운 사용 → 손쉬운 사용 접근 권한 허용 필요)
...
pyinstaller --noconfirm --windowed --name ResearchChatbot app.py
```
